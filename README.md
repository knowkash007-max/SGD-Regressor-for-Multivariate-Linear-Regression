...
## Algorithm
step1. Data Preparation Load the dataset using pandas, clean column names, and separate input features (Size, Bedrooms) and target variables (Price, Occupants).
...
## Output:
<img width="1145" height="77" alt="image" src="https://github.com/user-attachments/assets/f2e8e4a1-3150-4fc2-ab75-5b9602e1ccff" />
